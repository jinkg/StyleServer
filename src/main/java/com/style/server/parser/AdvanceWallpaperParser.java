...
public class AdvanceWallpaperParser {
    public static List<AdvanceWallpaperItem> parseToList() {
        ...
        item.author = "Yalin";
        item.iconUrl = "http://172.22.158.86:6060/advance/icons/cube.png";
        item.downloadUrl = "http://172.22.158.86:6060/advance/components/cube.component";
        ...
        item2.author = "Yalin";
        item2.iconUrl = "http://172.22.158.86:6060/advance/icons/the_blue.png";
        item2.downloadUrl = "http://172.22.158.86:6060/advance/components/blue.component";
        ...
        item3.author = "Yalin";
        item3.iconUrl = "http://172.22.158.86:6060/advance/icons/the_blue.png";
        item3.downloadUrl = "http://172.22.158.86:6060/advance/components/point.component";
        item3.checkSum = ChecksumUtil.getChecksum("./wallpapers/advance/components/point.component");
        item3.providerName = "com.yalin.component.point.ProviderImpl";
